...
pub const RENDEZVOUS_SERVERS: &[&str] = &["xynas.pro"];
pub const PUBLIC_RS_PUB_KEY: &str = "faAGA643Rsy5ZB5tgqnYTsKrR5Cf6r2PBrp+TfBPVQM=";
...
pub const RENDEZVOUS_PORT: i32 = 19001;
pub const RELAY_PORT: i32 = 19002;
